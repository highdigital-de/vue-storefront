  ...
  <div name="payone-test-container" id="payone_debit_payment" class="payment-form-container">
    ...
    <div class="input-row">
      <div class="input-container">
        <input id="ibanSepa" type="text" value="" v-model="iban" :class="{empty: iban === ''}">
        <label for="ibanSepa">Iban</label>
      </div>
    </div>
    <div class="input-row">
      <div class="input-container">
        <input id="bicSepa" type="text" value="" v-model="bic" :class="{empty: bic === ''}">
        <label for="bicSepa">Bic</label>
      </div>
    </div>
  </div>
</template>
